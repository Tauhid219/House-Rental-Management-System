...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'New Unit Registration', href: '/admin/flats/create' },
];

export default function FlatCreate({ commonAmenities }: CreateFlatProps) {
    ...
    return (
        <AdminLayout title="Register New Flat Unit • Skyline Heights" breadcrumbs={breadcrumbs}>
                    ...
                    <AdminCard
                        title={
                            <div className="flex items-center gap-2">
                                ...
                                <span>Unit Information & Specifications</span>
                            </div>
                        }
                        tools={
                            <Link
                    ...
                    >
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div>
                                    <label className="mb-1 block text-xs font-semibold text-slate-700 dark:text-slate-300">Initial Status *</label>
                                    <select
                                        value={data.status}
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        rows={3}
                                        placeholder="Key features, view orientation, layout details..."
                        ...
                        <div className="mt-8 flex items-center justify-end gap-3 border-t border-slate-100 pt-5 dark:border-slate-800">
                            ...
                            >
                                <Save size={15} />
                                <span>{processing ? 'Saving...' : 'Register Flat'}</span>
                            </button>
                        </div>
                    </AdminCard>
                </form>
