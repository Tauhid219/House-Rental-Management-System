                ...
                {vacantFlats.length === 0 ? (
                    <div className="rounded-md border border-amber-200 bg-amber-50 p-6 text-amber-800 dark:border-amber-900/60 dark:bg-amber-950/40 dark:text-amber-200">
                        ...
                        <p className="mt-2 text-xs leading-relaxed">
                            All units in Skyline Heights are currently occupied or under maintenance. To create a new lease agreement, either add a
                            new flat unit or terminate an existing active lease.
                        </p>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        ...
                                        >
                                            {vacantFlats.map((flat) => (
                                                <option key={flat.id} value={flat.id}>
                                                    Flat {flat.flat_number} ({flat.floor}, {flat.bedrooms} BHK - ৳
                                                    {Number(flat.rent_cost).toLocaleString()})
                                                </option>
                                            ))}
                                        </select>
                                        {errors.flat_id && <p className="mt-1 text-[11px] text-rose-600">{errors.flat_id}</p>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {errors.tenant_id && <p className="mt-1 text-[11px] text-rose-600">{errors.tenant_id}</p>}
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded border border-slate-300 bg-white px-3 py-2 text-xs text-slate-900 focus:border-blue-500 focus:outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                                        />
                                        {errors.end_date && <p className="mt-1 text-[11px] text-rose-600">{errors.end_date}</p>}
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        {errors.agreed_monthly_rent && <p className="mt-1 text-[11px] text-rose-600">{errors.agreed_monthly_rent}</p>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        {errors.security_deposit && <p className="mt-1 text-[11px] text-rose-600">{errors.security_deposit}</p>}
                                    </div>
                                ...
                                <div className="rounded border border-blue-100 bg-blue-50/60 p-4 text-xs text-blue-900 dark:border-blue-900/50 dark:bg-blue-950/30 dark:text-blue-200">
                                    <strong>Automation Notice:</strong> Executing this lease contract will automatically change the flat's status from{' '}
                                    <span className="font-semibold text-emerald-700 dark:text-emerald-400">vacant</span> to{' '}
                                    <span className="font-semibold text-blue-700 dark:text-blue-400">occupied</span> and assign the tenant as the
                                    registered occupant.
                                </div>
                            </div>
